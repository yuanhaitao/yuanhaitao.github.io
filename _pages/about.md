...
Haitao's research centers on **multi-modal data** (e.g., spatio-temporal, table, text, and graph), developing innovative database and machine learning technologies that can effectively and efficiently utilize such data to benefit people in areas such as transportation, healthcare, education, and more. To achieve this goal, Haitao concentrates on three key research fields (**SIP**): 
